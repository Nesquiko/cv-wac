...
describe('xcastven-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<xcastven-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></xcastven-ambulance-wl-editor>`,
    });

    await delay(300);
    await page.waitForChanges();

    const items: any = page.root.shadowRoot.querySelectorAll('md-filled-button');
  ...
  it('first text field is patient name', async () => {
    ...
    const items = page.root.shadowRoot.querySelectorAll('md-filled-text-field');
